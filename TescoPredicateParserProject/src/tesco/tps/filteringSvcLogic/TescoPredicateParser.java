...
public class TescoPredicateParser 
{
    ...
    public String filter(UserContext uc, String inboundDoc, String[] filters)
    {
    	...
    	try 
    	{
	    	for (int i=0; (i < filters.length); i++)
	    	{
	    		...
	    		m_userMemory = TescoFilterGrammarParser.usermemory.keySet();
	    		...
	    		reportOnMemory("usermemory", TescoFilterGrammarParser.usermemory);
	    		reportOnMemory("jsonmemory", TescoFilterGrammarParser.jsonmemory);
	    		reportOnMemory("resources", TescoFilterGrammarParser.resources);
	    	} 	
	    	evaluate();
	    	return outboundDoc;
    	}
    ...
    private void reportOnMemory(String s, HashMap h)
    {
		...
		{
			memorycell = iter.next();
			System.out.println(s + "[" + (j++) + "] -> [" + memorycell + "," + obj + "]");
		}
    ...
    {
    	System.out.println("bind(" + toBind + " to " + uc + ")");
    	//
    	...
    	for (i=0; (i < components.size()); i++)
    	{
    		...
    		try 
    		{
        		...
        		try 
        		{
        		  	...
        		  	{
        		  		System.out.println("Value to bind <" + obj + ">");
        		  		return obj;
        		  	}
        		} 
